...
a_whatever QuestionName 

Declare Method 
With a better input
My Goal is to write just Code
...
// 		9) How do you merge two unsorted arrays into single sorted array using
...
// 		27) Find first repeated character in a string? za_27
